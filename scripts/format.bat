@echo off
REM PrismQ.IdeaInspiration.Model Format Script for Windows
REM Target: Windows with NVIDIA RTX 5090, AMD Ryzen, 64GB RAM

echo =====================================
echo PrismQ.IdeaInspiration.Model Format
echo =====================================
echo.
...
echo.
echo Formatting code with Black (PEP 8)...
echo Target: Windows, NVIDIA RTX 5090, AMD Ryzen, 64GB RAM
echo.

REM Run black format
black prismq/ tests/
